...
app.get('/lastlvl/1111', (req, res) => {
    res.redirect('https://media.discordapp.net/attachments/510224047418769410/738814971697168394/1.png')
})

app.get('/lastlvl/111', (req, res) => {
    res.redirect('https://media.discordapp.net/attachments/510224047418769410/738516465937809539/2.jpg')
})
